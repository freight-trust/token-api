...
const tag = "latest";
const expectedUrl =
  "https://api.etherscan.io/api?action=balancemulti&module=account&address=0xddbd2b932c763ba5b1b7ae3b362eac3e8d40121a,0x63a9975ba31b0b9626b34300f7f627147df1f526,0x198ef1ec325a96cc354c7266a038be8b5c558f67&tag=latest&apikey=YourApiKeyToken";
test("exists", (t) => {
...
test("throws an error if there are more than 20 ", (t) => {
  const toManyAddress = Array.from(
    { length: 21 },
    () => "0xddbd2b932c763ba5b1b7ae3b362eac3e8d40121a"
  );
